...
def cost_volume_decoder(act0, act82, act87, act92, act97, act107, params, par_ich, par_och, par_och_k5, par,
    ...
    act109 = ng.conv2d(act108, weight109, strides=(1, 1, 1, 1), bias=bias109, scale=scale109, rshift_out=rshift109, act_func=ng.relu, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)


    # [110] cat
    rshift110 = ng.constant([1], dtype=ng.int8)
    act110 = ng.concat([ng.rshift_round(act109, rshift110, par=par), act97], axis=3)
    ...
    act112 = ng.conv2d(act111, weight112, strides=(1, 1, 1, 1), bias=bias112, scale=scale112, rshift_out=rshift112, act_func=ng.relu, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
    ...
    act113 = ng.conv2d(act112, weight113, strides=(1, 1, 1, 1), bias=bias113, rshift_out=rshift113, act_func=sigmoid, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
    ...
    act115 = ng.conv2d(act114, weight115, strides=(1, 1, 1, 1), bias=bias115, scale=scale115, rshift_out=rshift115, act_func=ng.relu, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
    ...
    act117 = ng.concat([act115, act92, ng.rshift_round(act116, rshift117, par=par)], axis=3)
    ...
    act119 = ng.conv2d(act118, weight119, strides=(1, 1, 1, 1), bias=bias119, scale=scale119, rshift_out=rshift119, act_func=ng.relu, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
    ...
    act120 = ng.conv2d(act119, weight120, strides=(1, 1, 1, 1), bias=bias120, rshift_out=rshift120, act_func=sigmoid, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
    ...
    act122 = ng.conv2d(act121, weight122, strides=(1, 1, 1, 1), bias=bias122, scale=scale122, rshift_out=rshift122, act_func=ng.relu, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
    ...
    act124 = ng.concat([act122, act87, ng.rshift_round(act123, rshift124, par=par)], axis=3)
    ...
    act126 = ng.conv2d(act125, weight126, strides=(1, 1, 1, 1), bias=bias126, scale=scale126, rshift_out=rshift126, act_func=ng.relu, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
    ...
    act127 = ng.conv2d(act126, weight127, strides=(1, 1, 1, 1), bias=bias127, rshift_out=rshift127, act_func=sigmoid, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
    ...
    act131 = ng.concat([act129, act82, ng.rshift_round(act130, rshift131, par=par)], axis=3)
    ...
    act134 = ng.conv2d(act133, weight134, strides=(1, 1, 1, 1), bias=bias134, rshift_out=rshift134, act_func=sigmoid, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
    ...
    act137 = ng.concat([ng.rshift_round(act136, rshift137s[0], par=par), ng.rshift_round(act135, rshift137s[1], par=par), act0], axis=3)
    ...
    act140 = ng.conv2d(act139, weight140, strides=(1, 1, 1, 1), bias=bias140, rshift_out=rshift140, act_func=sigmoid, asymmetric_clip=True, par_ich=par_ich, par_och=par_och, dtype=act_dtype, mul_dtype=mid_dtype, sum_dtype=mid_dtype)
