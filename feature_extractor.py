...
def feature_extractor(act0, params,
    ...
    conv1 = ng.multiply(ng.conv2d(act0, weight1, strides=(1, 2, 2, 1), dtype=mid_dtype), scale1)

    lshift1 = ng.constant([4], dtype=ng.int8)
    sum1 = ng.add(conv1, ng.lshift(bias1, lshift1))
    rshift1 = ng.constant([12], dtype=ng.int8)
    act1 = ng.relu(rshift_round_and_clip(sum1, rshift1, dtype=act_dtype))
    ...
    conv2 = ng.multiply(ng.conv2d(act1, weight2, strides=(1, 1, 1, 1), dtype=mid_dtype), scale2)

    lshift2 = ng.constant([1], dtype=ng.int8)
    sum2 = ng.add(conv2, ng.lshift(bias2, lshift2))
    rshift2 = ng.constant([7], dtype=ng.int8)
    act2 = ng.relu(rshift_round_and_clip(sum2, rshift2, dtype=act_dtype))
    ...
    conv3 = ng.multiply(ng.conv2d(act2, weight3, strides=(1, 1, 1, 1), dtype=mid_dtype), scale3)

    lshift3 = ng.constant([6], dtype=ng.int8)
    sum3 = ng.add(conv3, ng.lshift(bias3, lshift3))
    rshift3 = ng.constant([13], dtype=ng.int8)
    act3 = rshift_round_and_clip(sum3, rshift3, dtype=act_dtype)
    ...
    conv4 = ng.multiply(ng.conv2d(act3, weight4, strides=(1, 1, 1, 1), dtype=mid_dtype), scale4)

    lshift4 = ng.constant([3], dtype=ng.int8)
    sum4 = ng.add(conv4, ng.lshift(bias4, lshift4))
    rshift4 = ng.constant([11], dtype=ng.int8)
    act4 = ng.relu(rshift_round_and_clip(sum4, rshift4, dtype=act_dtype))
    ...
    conv5 = ng.multiply(ng.conv2d(act4, weight5, strides=(1, 2, 2, 1), dtype=mid_dtype), scale5)

    lshift5 = ng.constant([6], dtype=ng.int8)
    sum5 = ng.add(conv5, ng.lshift(bias5, lshift5))
    rshift5 = ng.constant([11], dtype=ng.int8)
    act5 = ng.relu(rshift_round_and_clip(sum5, rshift5, dtype=act_dtype))
    ...
    conv6 = ng.multiply(ng.conv2d(act5, weight6, strides=(1, 1, 1, 1), dtype=mid_dtype), scale6)

    lshift6 = ng.constant([6], dtype=ng.int8)
    sum6 = ng.add(conv6, ng.lshift(bias6, lshift6))
    rshift6 = ng.constant([13], dtype=ng.int8)
    act6 = rshift_round_and_clip(sum6, rshift6, dtype=act_dtype)
    ...
    conv7 = ng.multiply(ng.conv2d(act6, weight7, strides=(1, 1, 1, 1), dtype=mid_dtype), scale7)

    lshift7 = ng.constant([4], dtype=ng.int8)
    sum7 = ng.add(conv7, ng.lshift(bias7, lshift7))
    rshift7 = ng.constant([11], dtype=ng.int8)
    act7 = ng.relu(rshift_round_and_clip(sum7, rshift7, dtype=act_dtype))
    ...
    conv8 = ng.multiply(ng.conv2d(act7, weight8, strides=(1, 1, 1, 1), dtype=mid_dtype), scale8)

    lshift8 = ng.constant([5], dtype=ng.int8)
    sum8 = ng.add(conv8, ng.lshift(bias8, lshift8))
    rshift8 = ng.constant([11], dtype=ng.int8)
    act8 = ng.relu(rshift_round_and_clip(sum8, rshift8, dtype=act_dtype))
    ...
    conv9 = ng.multiply(ng.conv2d(act8, weight9, strides=(1, 1, 1, 1), dtype=mid_dtype), scale9)

    lshift9 = ng.constant([5], dtype=ng.int8)
    sum9 = ng.add(conv9, ng.lshift(bias9, lshift9))
    rshift9 = ng.constant([13], dtype=ng.int8)
    act9 = rshift_round_and_clip(sum9, rshift9, dtype=act_dtype)
    ...
    conv11 = ng.multiply(ng.conv2d(act10, weight11, strides=(1, 1, 1, 1), dtype=mid_dtype), scale11)

    lshift11 = ng.constant([4], dtype=ng.int8)
    sum11 = ng.add(conv11, ng.lshift(bias11, lshift11))
    rshift11 = ng.constant([12], dtype=ng.int8)
    act11 = ng.relu(rshift_round_and_clip(sum11, rshift11, dtype=act_dtype))
    ...
    conv12 = ng.multiply(ng.conv2d(act11, weight12, strides=(1, 1, 1, 1), dtype=mid_dtype), scale12)

    lshift12 = ng.constant([2], dtype=ng.int8)
    sum12 = ng.add(conv12, ng.lshift(bias12, lshift12))
    rshift12 = ng.constant([8], dtype=ng.int8)
    act12 = ng.relu(rshift_round_and_clip(sum12, rshift12, dtype=act_dtype))
    ...
    conv13 = ng.multiply(ng.conv2d(act12, weight13, strides=(1, 1, 1, 1), dtype=mid_dtype), scale13)

    lshift13 = ng.constant([7], dtype=ng.int8)
    sum13 = ng.add(conv13, ng.lshift(bias13, lshift13))
    rshift13 = ng.constant([14], dtype=ng.int8)
    act13 = rshift_round_and_clip(sum13, rshift13, dtype=act_dtype)
    ...
    conv15 = ng.multiply(ng.conv2d(act14, weight15, strides=(1, 1, 1, 1), dtype=mid_dtype), scale15)

    lshift15 = ng.constant([4], dtype=ng.int8)
    sum15 = ng.add(conv15, ng.lshift(bias15, lshift15))
    rshift15 = ng.constant([13], dtype=ng.int8)
    act15 = ng.relu(rshift_round_and_clip(sum15, rshift15, dtype=act_dtype))
    ...
    conv16 = ng.multiply(ng.conv2d(act15, weight16, strides=(1, 2, 2, 1), dtype=mid_dtype), scale16)

    lshift16 = ng.constant([5], dtype=ng.int8)
    sum16 = ng.add(conv16, ng.lshift(bias16, lshift16))
    rshift16 = ng.constant([11], dtype=ng.int8)
    act16 = ng.relu(rshift_round_and_clip(sum16, rshift16, dtype=act_dtype))
    ...
    conv17 = ng.multiply(ng.conv2d(act16, weight17, strides=(1, 1, 1, 1), dtype=mid_dtype), scale17)

    lshift17 = ng.constant([7], dtype=ng.int8)
    sum17 = ng.add(conv17, ng.lshift(bias17, lshift17))
    rshift17 = ng.constant([13], dtype=ng.int8)
    act17 = rshift_round_and_clip(sum17, rshift17, dtype=act_dtype)
    ...
    conv18 = ng.multiply(ng.conv2d(act17, weight18, strides=(1, 1, 1, 1), dtype=mid_dtype), scale18)

    lshift18 = ng.constant([6], dtype=ng.int8)
    sum18 = ng.add(conv18, ng.lshift(bias18, lshift18))
    rshift18 = ng.constant([13], dtype=ng.int8)
    act18 = ng.relu(rshift_round_and_clip(sum18, rshift18, dtype=act_dtype))
    ...
    conv19 = ng.multiply(ng.conv2d(act18, weight19, strides=(1, 1, 1, 1), dtype=mid_dtype), scale19)

    lshift19 = ng.constant([5], dtype=ng.int8)
    sum19 = ng.add(conv19, ng.lshift(bias19, lshift19))
    rshift19 = ng.constant([9], dtype=ng.int8)
    act19 = ng.relu(rshift_round_and_clip(sum19, rshift19, dtype=act_dtype))
    ...
    conv20 = ng.multiply(ng.conv2d(act19, weight20, strides=(1, 1, 1, 1), dtype=mid_dtype), scale20)

    lshift20 = ng.constant([6], dtype=ng.int8)
    sum20 = ng.add(conv20, ng.lshift(bias20, lshift20))
    rshift20 = ng.constant([13], dtype=ng.int8)
    act20 = rshift_round_and_clip(sum20, rshift20, dtype=act_dtype)
    ...
    conv22 = ng.multiply(ng.conv2d(act21, weight22, strides=(1, 1, 1, 1), dtype=mid_dtype), scale22)

    lshift22 = ng.constant([4], dtype=ng.int8)
    sum22 = ng.add(conv22, ng.lshift(bias22, lshift22))
    rshift22 = ng.constant([12], dtype=ng.int8)
    act22 = ng.relu(rshift_round_and_clip(sum22, rshift22, dtype=act_dtype))
    ...
    conv23 = ng.multiply(ng.conv2d(act22, weight23, strides=(1, 1, 1, 1), dtype=mid_dtype), scale23)

    lshift23 = ng.constant([3], dtype=ng.int8)
    sum23 = ng.add(conv23, ng.lshift(bias23, lshift23))
    rshift23 = ng.constant([9], dtype=ng.int8)
    act23 = ng.relu(rshift_round_and_clip(sum23, rshift23, dtype=act_dtype))
    ...
    conv24 = ng.multiply(ng.conv2d(act23, weight24, strides=(1, 1, 1, 1), dtype=mid_dtype), scale24)

    lshift24 = ng.constant([7], dtype=ng.int8)
    sum24 = ng.add(conv24, ng.lshift(bias24, lshift24))
    rshift24 = ng.constant([13], dtype=ng.int8)
    act24 = rshift_round_and_clip(sum24, rshift24, dtype=act_dtype)
    ...
    conv26 = ng.multiply(ng.conv2d(act25, weight26, strides=(1, 1, 1, 1), dtype=mid_dtype), scale26)

    lshift26 = ng.constant([4], dtype=ng.int8)
    sum26 = ng.add(conv26, ng.lshift(bias26, lshift26))
    rshift26 = ng.constant([12], dtype=ng.int8)
    act26 = ng.relu(rshift_round_and_clip(sum26, rshift26, dtype=act_dtype))
    ...
    conv27 = ng.multiply(ng.conv2d(act26, weight27, strides=(1, 2, 2, 1), dtype=mid_dtype), scale27)

    lshift27 = ng.constant([5], dtype=ng.int8)
    sum27 = ng.add(conv27, ng.lshift(bias27, lshift27))
    rshift27 = ng.constant([12], dtype=ng.int8)
    act27 = ng.relu(rshift_round_and_clip(sum27, rshift27, dtype=act_dtype))
    ...
    conv28 = ng.multiply(ng.conv2d(act27, weight28, strides=(1, 1, 1, 1), dtype=mid_dtype), scale28)

    lshift28 = ng.constant([6], dtype=ng.int8)
    sum28 = ng.add(conv28, ng.lshift(bias28, lshift28))
    rshift28 = ng.constant([13], dtype=ng.int8)
    act28 = rshift_round_and_clip(sum28, rshift28, dtype=act_dtype)
    ...
    conv29 = ng.multiply(ng.conv2d(act28, weight29, strides=(1, 1, 1, 1), dtype=mid_dtype), scale29)

    lshift29 = ng.constant([6], dtype=ng.int8)
    sum29 = ng.add(conv29, ng.lshift(bias29, lshift29))
    rshift29 = ng.constant([13], dtype=ng.int8)
    act29 = ng.relu(rshift_round_and_clip(sum29, rshift29, dtype=act_dtype))
    ...
    conv30 = ng.multiply(ng.conv2d(act29, weight30, strides=(1, 1, 1, 1), dtype=mid_dtype), scale30)

    lshift30 = ng.constant([2], dtype=ng.int8)
    sum30 = ng.add(conv30, ng.lshift(bias30, lshift30))
    rshift30 = ng.constant([7], dtype=ng.int8)
    act30 = ng.relu(rshift_round_and_clip(sum30, rshift30, dtype=act_dtype))
    ...
    conv31 = ng.multiply(ng.conv2d(act30, weight31, strides=(1, 1, 1, 1), dtype=mid_dtype), scale31)

    lshift31 = ng.constant([9], dtype=ng.int8)
    sum31 = ng.add(conv31, ng.lshift(bias31, lshift31))
    rshift31 = ng.constant([14], dtype=ng.int8)
    act31 = rshift_round_and_clip(sum31, rshift31, dtype=act_dtype)
    ...
    conv33 = ng.multiply(ng.conv2d(act32, weight33, strides=(1, 1, 1, 1), dtype=mid_dtype), scale33)

    lshift33 = ng.constant([5], dtype=ng.int8)
    sum33 = ng.add(conv33, ng.lshift(bias33, lshift33))
    rshift33 = ng.constant([12], dtype=ng.int8)
    act33 = ng.relu(rshift_round_and_clip(sum33, rshift33, dtype=act_dtype))
    ...
    conv34 = ng.multiply(ng.conv2d(act33, weight34, strides=(1, 1, 1, 1), dtype=mid_dtype), scale34)

    lshift34 = ng.constant([2], dtype=ng.int8)
    sum34 = ng.add(conv34, ng.lshift(bias34, lshift34))
    rshift34 = ng.constant([8], dtype=ng.int8)
    act34 = ng.relu(rshift_round_and_clip(sum34, rshift34, dtype=act_dtype))
    ...
    conv35 = ng.multiply(ng.conv2d(act34, weight35, strides=(1, 1, 1, 1), dtype=mid_dtype), scale35)

    lshift35 = ng.constant([6], dtype=ng.int8)
    sum35 = ng.add(conv35, ng.lshift(bias35, lshift35))
    rshift35 = ng.constant([13], dtype=ng.int8)
    act35 = rshift_round_and_clip(sum35, rshift35, dtype=act_dtype)
    ...
    conv37 = ng.multiply(ng.conv2d(act36, weight37, strides=(1, 1, 1, 1), dtype=mid_dtype), scale37)

    lshift37 = ng.constant([6], dtype=ng.int8)
    sum37 = ng.add(conv37, ng.lshift(bias37, lshift37))
    rshift37 = ng.constant([12], dtype=ng.int8)
    act37 = ng.relu(rshift_round_and_clip(sum37, rshift37, dtype=act_dtype))
    ...
    conv38 = ng.multiply(ng.conv2d(act37, weight38, strides=(1, 1, 1, 1), dtype=mid_dtype), scale38)

    lshift38 = ng.constant([3], dtype=ng.int8)
    sum38 = ng.add(conv38, ng.lshift(bias38, lshift38))
    rshift38 = ng.constant([9], dtype=ng.int8)
    act38 = ng.relu(rshift_round_and_clip(sum38, rshift38, dtype=act_dtype))
    ...
    conv39 = ng.multiply(ng.conv2d(act38, weight39, strides=(1, 1, 1, 1), dtype=mid_dtype), scale39)

    lshift39 = ng.constant([7], dtype=ng.int8)
    sum39 = ng.add(conv39, ng.lshift(bias39, lshift39))
    rshift39 = ng.constant([14], dtype=ng.int8)
    act39 = rshift_round_and_clip(sum39, rshift39, dtype=act_dtype)
    ...
    conv40 = ng.multiply(ng.conv2d(act39, weight40, strides=(1, 1, 1, 1), dtype=mid_dtype), scale40)

    lshift40 = ng.constant([6], dtype=ng.int8)
    sum40 = ng.add(conv40, ng.lshift(bias40, lshift40))
    rshift40 = ng.constant([13], dtype=ng.int8)
    act40 = ng.relu(rshift_round_and_clip(sum40, rshift40, dtype=act_dtype))
    ...
    conv41 = ng.multiply(ng.conv2d(act40, weight41, strides=(1, 1, 1, 1), dtype=mid_dtype), scale41)

    lshift41 = ng.constant([2], dtype=ng.int8)
    sum41 = ng.add(conv41, ng.lshift(bias41, lshift41))
    rshift41 = ng.constant([7], dtype=ng.int8)
    act41 = ng.relu(rshift_round_and_clip(sum41, rshift41, dtype=act_dtype))
    ...
    conv42 = ng.multiply(ng.conv2d(act41, weight42, strides=(1, 1, 1, 1), dtype=mid_dtype), scale42)

    lshift42 = ng.constant([8], dtype=ng.int8)
    sum42 = ng.add(conv42, ng.lshift(bias42, lshift42))
    rshift42 = ng.constant([15], dtype=ng.int8)
    act42 = rshift_round_and_clip(sum42, rshift42, dtype=act_dtype)
    ...
    conv44 = ng.multiply(ng.conv2d(act43, weight44, strides=(1, 1, 1, 1), dtype=mid_dtype), scale44)

    lshift44 = ng.constant([5], dtype=ng.int8)
    sum44 = ng.add(conv44, ng.lshift(bias44, lshift44))
    rshift44 = ng.constant([12], dtype=ng.int8)
    act44 = ng.relu(rshift_round_and_clip(sum44, rshift44, dtype=act_dtype))
    ...
    conv45 = ng.multiply(ng.conv2d(act44, weight45, strides=(1, 2, 2, 1), dtype=mid_dtype), scale45)

    lshift45 = ng.constant([3], dtype=ng.int8)
    sum45 = ng.add(conv45, ng.lshift(bias45, lshift45))
    rshift45 = ng.constant([9], dtype=ng.int8)
    act45 = ng.relu(rshift_round_and_clip(sum45, rshift45, dtype=act_dtype))
    ...
    conv46 = ng.multiply(ng.conv2d(act45, weight46, strides=(1, 1, 1, 1), dtype=mid_dtype), scale46)

    lshift46 = ng.constant([8], dtype=ng.int8)
    sum46 = ng.add(conv46, ng.lshift(bias46, lshift46))
    rshift46 = ng.constant([15], dtype=ng.int8)
    act46 = rshift_round_and_clip(sum46, rshift46, dtype=act_dtype)
    ...
    conv47 = ng.multiply(ng.conv2d(act46, weight47, strides=(1, 1, 1, 1), dtype=mid_dtype), scale47)

    lshift47 = ng.constant([6], dtype=ng.int8)
    sum47 = ng.add(conv47, ng.lshift(bias47, lshift47))
    rshift47 = ng.constant([13], dtype=ng.int8)
    act47 = ng.relu(rshift_round_and_clip(sum47, rshift47, dtype=act_dtype))
    ...
    conv48 = ng.multiply(ng.conv2d(act47, weight48, strides=(1, 1, 1, 1), dtype=mid_dtype), scale48)

    lshift48 = ng.constant([1], dtype=ng.int8)
    sum48 = ng.add(conv48, ng.lshift(bias48, lshift48))
    rshift48 = ng.constant([7], dtype=ng.int8)
    act48 = ng.relu(rshift_round_and_clip(sum48, rshift48, dtype=act_dtype))
    ...
    conv49 = ng.multiply(ng.conv2d(act48, weight49, strides=(1, 1, 1, 1), dtype=mid_dtype), scale49)

    lshift49 = ng.constant([8], dtype=ng.int8)
    sum49 = ng.add(conv49, ng.lshift(bias49, lshift49))
    rshift49 = ng.constant([15], dtype=ng.int8)
    act49 = rshift_round_and_clip(sum49, rshift49, dtype=act_dtype)
    ...
    conv51 = ng.multiply(ng.conv2d(act50, weight51, strides=(1, 1, 1, 1), dtype=mid_dtype), scale51)

    lshift51 = ng.constant([6], dtype=ng.int8)
    sum51 = ng.add(conv51, ng.lshift(bias51, lshift51))
    rshift51 = ng.constant([13], dtype=ng.int8)
    act51 = ng.relu(rshift_round_and_clip(sum51, rshift51, dtype=act_dtype))
    ...
    conv52 = ng.multiply(ng.conv2d(act51, weight52, strides=(1, 1, 1, 1), dtype=mid_dtype), scale52)

    lshift52 = ng.constant([2], dtype=ng.int8)
    sum52 = ng.add(conv52, ng.lshift(bias52, lshift52))
    rshift52 = ng.constant([7], dtype=ng.int8)
    act52 = ng.relu(rshift_round_and_clip(sum52, rshift52, dtype=act_dtype))
    ...
    conv53 = ng.multiply(ng.conv2d(act52, weight53, strides=(1, 1, 1, 1), dtype=mid_dtype), scale53)

    lshift53 = ng.constant([8], dtype=ng.int8)
    sum53 = ng.add(conv53, ng.lshift(bias53, lshift53))
    rshift53 = ng.constant([15], dtype=ng.int8)
    act53 = rshift_round_and_clip(sum53, rshift53, dtype=act_dtype)
    ...
    conv55 = ng.multiply(ng.conv2d(act54, weight55, strides=(1, 1, 1, 1), dtype=mid_dtype), scale55)

    lshift55 = ng.constant([7], dtype=ng.int8)
    sum55 = ng.add(conv55, ng.lshift(bias55, lshift55))
    rshift55 = ng.constant([14], dtype=ng.int8)
    act55 = ng.relu(rshift_round_and_clip(sum55, rshift55, dtype=act_dtype))
    ...
    conv56 = ng.multiply(ng.conv2d(act55, weight56, strides=(1, 1, 1, 1), dtype=mid_dtype), scale56)

    lshift56 = ng.constant([2], dtype=ng.int8)
    sum56 = ng.add(conv56, ng.lshift(bias56, lshift56))
    rshift56 = ng.constant([7], dtype=ng.int8)
    act56 = ng.relu(rshift_round_and_clip(sum56, rshift56, dtype=act_dtype))
    ...
    conv57 = ng.multiply(ng.conv2d(act56, weight57, strides=(1, 1, 1, 1), dtype=mid_dtype), scale57)

    lshift57 = ng.constant([9], dtype=ng.int8)
    sum57 = ng.add(conv57, ng.lshift(bias57, lshift57))
    rshift57 = ng.constant([15], dtype=ng.int8)
    act57 = rshift_round_and_clip(sum57, rshift57, dtype=act_dtype)
    ...
    conv59 = ng.multiply(ng.conv2d(act58, weight59, strides=(1, 1, 1, 1), dtype=mid_dtype), scale59)

    lshift59 = ng.constant([7], dtype=ng.int8)
    sum59 = ng.add(conv59, ng.lshift(bias59, lshift59))
    rshift59 = ng.constant([14], dtype=ng.int8)
    act59 = ng.relu(rshift_round_and_clip(sum59, rshift59, dtype=act_dtype))
    ...
    conv60 = ng.multiply(ng.conv2d(act59, weight60, strides=(1, 1, 1, 1), dtype=mid_dtype), scale60)

    lshift60 = ng.constant([3], dtype=ng.int8)
    sum60 = ng.add(conv60, ng.lshift(bias60, lshift60))
    rshift60 = ng.constant([9], dtype=ng.int8)
    act60 = ng.relu(rshift_round_and_clip(sum60, rshift60, dtype=act_dtype))
    ...
    conv61 = ng.multiply(ng.conv2d(act60, weight61, strides=(1, 1, 1, 1), dtype=mid_dtype), scale61)

    lshift61 = ng.constant([9], dtype=ng.int8)
    sum61 = ng.add(conv61, ng.lshift(bias61, lshift61))
    rshift61 = ng.constant([15], dtype=ng.int8)
    act61 = rshift_round_and_clip(sum61, rshift61, dtype=act_dtype)
